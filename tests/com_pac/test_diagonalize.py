...
def random_pa_coords3():
    return np.array(
        [
            ...
            [1.36349489, 3.5615436, -0.33577621],
            [-3.94361828, -1.09144974, -1.3557945],
            [6.34396972, 1.10802758, 0.9194625],
            [1.74662306, -1.54185803, -2.33758032],
            [0.59838802, -0.98101608, 5.40780288],
            [1.02688675, 1.27191353, 1.81866345],
            [-5.90216336, 0.02098458, 1.25419816],
            [-3.09232181, 2.07665614, 2.5331536],
            [-4.42996416, -0.84218229, -0.21092401],
            [2.01703806, -5.23351755, 0.21747675],
            [6.27522662, -0.33634895, -3.51925308],
            [2.52371251, -0.82263066, 1.88832696],
            [-1.40089926, 2.39273128, -2.63446668],
        ]
    )
...
class Test_get_eigens:
    ...
    def test_right_handed_coordinate_system(self, f_COM_inertia, request):
        """Eigenvector matrix must form a right-handed coordinate system (det = +1)."""
        COM_inertia = request.getfixturevalue(f_COM_inertia)
